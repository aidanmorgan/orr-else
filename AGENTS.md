...
- Manage isolated Git worktrees only for Implementation states.
...
2. The coordinator fills up to six tmux teammate slots, claims Beads, and creates worktrees for Implementation states.
